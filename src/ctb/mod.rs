use std::os::raw::{c_void, c_char, c_uchar, c_short, c_ushort, c_int, c_uint};
use super::types;
...
pub struct XCBEnterNotifyEvent
{
    ...
    pub detail: c_uchar,
    pub sequence: c_ushort,
    pub time: types::XCBTimestamp,
    pub root: types::XCBWindow,
    pub event: types::XCBWindow,
    pub child: types::XCBWindow,
    pub root_x: c_short,
    pub root_y: c_short,
    pub event_x: c_short,
    pub event_y: c_short,
...
extern "system"
{
    ...
    pub fn xcb_create_window(connection: *mut XCBConnection,
        ...
        visual: c_uint,
        value_mask: c_uint,
        value_list: *const c_uint) -> XCBVoidCookie;
    pub fn xcb_get_setup(connection: *mut XCBConnection) -> *const types::XCBSetup;
    pub fn xcb_setup_roots_iterator(setup: *const types::XCBSetup) -> XCBScreenIterator;
    pub fn xcb_map_window(connection: *mut XCBConnection, window: types::XCBWindow) -> XCBVoidCookie;
    ...
    pub fn xcb_destroy_window(connection: *mut XCBConnection, window: types::XCBWindow) -> XCBVoidCookie;
    pub fn xcb_intern_atom(connection: *mut XCBConnection, only_if_exists: c_uchar, name_len: c_ushort, name: *const c_char) -> XCBInternAtomCookie;
    pub fn xcb_intern_atom_reply(connection: *mut XCBConnection, cookie: XCBInternAtomCookie, e: *mut *mut XCBGenericError) -> *mut XCBInternAtomReply;
    pub fn xcb_change_property(connection: *mut XCBConnection,
        mode: c_uchar,
        ...
        format: c_uchar,
        data_len: c_uint,
        data: *const c_void) -> XCBVoidCookie;
    pub fn xcb_get_atom_name(connection: *mut XCBConnection, atom: XCBAtom) -> XCBGetAtomNameCookie;
    pub fn xcb_get_atom_name_reply(connection: *mut XCBConnection, cookie: XCBGetAtomNameCookie, e: *mut *mut XCBGenericError) -> *mut XCBGetAtomNameReply;
    pub fn xcb_create_colormap(connection: *mut XCBConnection, alloc: c_uchar, mid: types::XCBColormap, window: types::XCBWindow, visual: types::XCBVisualId) -> XCBVoidCookie;
}